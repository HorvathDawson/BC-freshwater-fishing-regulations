...
Usage
-----
    python -m regulation_mapping_v2.parsing.parser
    python -m regulation_mapping_v2.parsing.parser --dry-run
    python -m regulation_mapping_v2.parsing.parser --batch-size 30
"""
...
def main() -> None:
    ...
    config = get_config()
    llm_cfg = load_config()["synopsis_pipeline"]["llm"]
    ...
    # Output directory: output/regulation_mapping_v2/parsing/
    if args.output:
        ...
        out_dir = (
            config.project_root / cfg["output"]["regulation_mapping_v2"]["parsing"]
        )
