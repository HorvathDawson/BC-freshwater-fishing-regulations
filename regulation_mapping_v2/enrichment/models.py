...
class FeatureAssignment:
    ...
    def assign_fid(self, fid: str, reg_id: str, *, phase: int) -> None:
    ...
    def assign_wbk(self, wbk: str, reg_id: str, *, phase: int) -> None:
    ...
    def assign_fids_bulk(self, fids: Set[str], reg_id: str, *, phase: int) -> int:
    ...
    def assign_wbks_bulk(self, wbks: Set[str], reg_id: str, *, phase: int) -> int:
