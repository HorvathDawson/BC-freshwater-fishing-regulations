...
Usage
-----
    python -m regulation_mapping_v2.matching.generate_overrides
    python -m regulation_mapping_v2.matching.generate_overrides --dry-run
    python -m regulation_mapping_v2.matching.generate_overrides \
...
def main() -> None:
    ...
    match_table_path = (
        ...
        / cfg["output"]["regulation_mapping_v2"]["match_table"]
    )
