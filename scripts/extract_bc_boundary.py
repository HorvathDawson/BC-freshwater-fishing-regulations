...
OUTPUT_PATH = Path(__file__).resolve().parent.parent / "webapp" / "public" / "data" / "bc_boundary.geojson"
...
def main() -> None:
    ...
    gdf_out = gpd.GeoDataFrame(geometry=[bc_simple], crs="EPSG:3005").to_crs("EPSG:4326")
