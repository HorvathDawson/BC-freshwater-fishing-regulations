...
class ManualCorrections:
    """
    Manages manual name variations, direct feature matches, skip entries, and unmarked waterbodies.
...
SKIP_ENTRIES: Dict[str, Dict[str, SkipEntry]] = {
    ...
    "Region 7": {
        ...
        "LIARD RIVER WATERSHED (see map on page 63)": SkipEntry(
            note="Regulation specifies 'LIARD RIVER WATERSHED (see map on page 63)' in MU 7-53. Requires custom watershed polygon creation based on regulation map. Cannot link to river line features as regulations apply to watershed area. FWA NAMED WATERSHED: Named Watershed ID 5, Object ID 6422089. Reference: BC Freshwater Fishing Regulations Synopsis 2024-2026, Region 7, page 63.",
            not_found=True,
        ),
